...
const DEMOS = [
  ...
  },
  {
    ...
    best_review_text: 'Best cleaning service we have ever used. The team was punctual, incredibly thorough, and left our office spotless. We have booked them for weekly cleans going forward.',
    google_rating: 4.8,
    review_count: 318,
    phone: '0413 456 789',
    ...
    selected_review_json: JSON.stringify({
      ...
      text: 'Best cleaning service we have ever used. The team was punctual, incredibly thorough, and left our office spotless. We have booked them for weekly cleans going forward.',
      rating: 5,
    }),
  },
  {
    ...
    best_review_text: 'Called them for an emergency leak on a Sunday morning and they were here within the hour. Fixed the issue quickly, fair pricing, and cleaned up after themselves. Cannot fault them.',
    google_rating: 4.7,
    review_count: 256,
    phone: '0414 567 890',
    ...
    selected_review_json: JSON.stringify({
      ...
      text: 'Called them for an emergency leak on a Sunday morning and they were here within the hour. Fixed the issue quickly, fair pricing, and cleaned up after themselves. Cannot fault them.',
      rating: 5,
    }),
  },
];
