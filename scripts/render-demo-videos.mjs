...
const DEMOS = [
  ...
  },
  {
    slug: 'cleaning',
    id: 900002,
    business_name: 'Maid2Go Cleaning Sydney',
    city: 'Sydney',
    niche: 'house cleaning service',
    country_code: 'AU',
    best_review_author: 'Mandy Kwon',
    best_review_text: 'I recently booked a deep clean with Maid2Go, and I cannot express how much of a relief the experience was. The quote was really reasonable as well as the extra cleaning fee. I also want to specifically mention how wonderful the cleaner, Rahman, was throughout the process. He was incredibly respectful, professional, and left the place absolutely sparkling. He cleaned places that I wouldn\'t have even thought to touch. Every hidden corner and neglected surface was addressed with such care and the level of thoroughness was truly incredible. I am so satisfied with the results and highly recommend Maid2Go to anyone who needs a thorough reset for their home.',
    google_rating: 4.9,
    review_count: 827,
    phone: '1300 364 646',
    problem_category: 'deep-clean',
    logo_url: 'https://cdn.auditandfix.com/demo-logo-maid2go.png', // pii-ok
    selected_review_json: JSON.stringify({
      author_name: 'Mandy Kwon',
      text: 'I recently booked a deep clean with Maid2Go, and I cannot express how much of a relief the experience was. The quote was really reasonable as well as the extra cleaning fee. I also want to specifically mention how wonderful the cleaner, Rahman, was throughout the process. He was incredibly respectful, professional, and left the place absolutely sparkling. He cleaned places that I wouldn\'t have even thought to touch. Every hidden corner and neglected surface was addressed with such care and the level of thoroughness was truly incredible. I am so satisfied with the results and highly recommend Maid2Go to anyone who needs a thorough reset for their home.',
      rating: 5,
    }),
  },
  {
